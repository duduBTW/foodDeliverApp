...
class BodyRestaurante extends StatelessWidget {
  void _redirectPrato(BuildContext context) {
    Navigator.of(context).pushNamed('/prato');
  }
...
class PratoItem extends StatelessWidget {
  final Function redirectPrato;

  const PratoItem(this.redirectPrato);
